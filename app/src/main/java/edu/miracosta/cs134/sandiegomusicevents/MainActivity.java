...
public class MainActivity extends AppCompatActivity {
    ...
    private MusicEventListAdopter mMusicEventListtAdapter;
...
*/
        ...
        mMusicEventListtAdapter = new MusicEventListAdopter(this, R.layout.event_list_item, eventsList);
        // TODO: Set the adapter of the list view to the newly instantiated adapter
        mMusicEventListView.setAdapter(mMusicEventListtAdapter);
    }
